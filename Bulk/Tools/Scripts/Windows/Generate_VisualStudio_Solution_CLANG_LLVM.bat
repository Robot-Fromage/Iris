...
:: Rebuild Project
cmake -G "Visual Studio 15 2017 Win64" -T"llvm" -DIRIS_USE_CONFIG:BOOL=ON -DIRIS_EXPLICIT_COMPILER_ID:STRING="CLANG" -DIRIS_EXPLICIT_HOST_ID:STRING="WIN" ../Source

:: Create symbolic link to solution in root
cd ../../
IF EXIST IRIS_CLANG_LLVM.sln ( del IRIS_CLANG_LLVM.sln )
mklink "IRIS_CLANG_LLVM.sln" "Bulk\Generated_VisualStudio_Solution_CLANG_LLVM\IRIS.sln"
